...
int PWM = 0;
__IO int MaxPWM = 999;
double AngleOrig = 0, AngleComp = 0, AngleRef = 0, AngleMax = 15, AngleOfs = 0;
...
int16_t AX; /*!< Accelerometer value X axis */
int16_t AY; /*!< Accelerometer value Y axis */
int16_t AZ; /*!< Accelerometer value Z axis */
